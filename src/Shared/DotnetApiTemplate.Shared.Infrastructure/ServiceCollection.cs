...
namespace DotnetApiTemplate.Shared.Infrastructure;
...
public static class ServiceCollection
{
  ...
  public static void AddQueueConfiguration(this IServiceCollection services)
  {
    var appOptions = services.GetOptions<QueueConfiguration>("QueueConfiguration");
    services.AddSingleton(appOptions);
  }
