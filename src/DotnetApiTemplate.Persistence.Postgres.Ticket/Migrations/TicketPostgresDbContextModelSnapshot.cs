...
namespace DotnetApiTemplate.Persistence.Postgres.Ticket.Migrations
{
    ...
    partial class TicketPostgresDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotnetApiTemplate.Persistence.Postgres.Ticket.Entities.MsEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DotnetApiTemplate.Persistence.Postgres.Ticket.Entities.TrBookingTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DotnetApiTemplate.Persistence.Postgres.Ticket.Entities.TrPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DotnetApiTemplate.Persistence.Postgres.Ticket.Entities.TrBookingTicket", b =>
                {
                    b.HasOne("DotnetApiTemplate.Persistence.Postgres.Ticket.Entities.MsEvent", "Event")
                        .WithMany("Booking")
            ...
            modelBuilder.Entity("DotnetApiTemplate.Persistence.Postgres.Ticket.Entities.TrPayment", b =>
                {
                    b.HasOne("DotnetApiTemplate.Persistence.Postgres.Ticket.Entities.TrBookingTicket", "BookingTicket")
                        .WithMany()
