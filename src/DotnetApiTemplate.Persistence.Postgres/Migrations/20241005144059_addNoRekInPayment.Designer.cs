...
namespace DotnetApiTemplate.Persistence.Postgres.Migrations
{
    ...
    [Migration("20241005144059_addNoRekInPayment")]
    partial class addNoRekInPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotnetApiTemplate.Domain.Entities.MsBank", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DotnetApiTemplate.Domain.Entities.TrBookingTicket", b =>
                {
                    ...
                    b.Property<Guid?>("MsEventBrokerId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DotnetApiTemplate.Domain.Entities.TrBookingTicket", b =>
                {
                    ...
                    b.HasOne("DotnetApiTemplate.Domain.Entities.MsEventBroker", null)
                        .WithMany("BookingBroker")
                        .HasForeignKey("MsEventBrokerId");
            ...
            modelBuilder.Entity("DotnetApiTemplate.Domain.Entities.TrBookingTicketBroker", b =>
                {
                    ...
                    b.HasOne("DotnetApiTemplate.Domain.Entities.MsEvent", null)
                        .WithMany("BookingBroker")
                        .HasForeignKey("MsEventId");
            ...
            modelBuilder.Entity("DotnetApiTemplate.Domain.Entities.TrPayment", b =>
                {
                    b.HasOne("DotnetApiTemplate.Domain.Entities.TrBookingTicketBroker", "BookingTicket")
                        .WithMany()
